...
if [[ $language == "us" ]]; then
	dunstify -I /home/gars/.config/dunst/keyboard_icon_reversed.png -r 2593 -u normal "IL"
	setxkbmap il
	echo "the language is now IL"
else
	dunstify -I /home/gars/.config/dunst/keyboard_icon_reversed.png -r 2593 -u normal "US"
	setxkbmap us
